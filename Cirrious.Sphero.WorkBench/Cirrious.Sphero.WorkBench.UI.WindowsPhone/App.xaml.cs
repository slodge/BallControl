// <copyright file="App.xaml.cs" company="Cirrious">
...
namespace Cirrious.Sphero.WorkBench.UI.WindowsPhone
{
        ...
        : Application
    {
        ...
        {
            RootFrame.Navigating += RootFrame_OnNavigating;
        }

        private void RootFrame_OnNavigating(object sender, NavigatingCancelEventArgs navigatingCancelEventArgs)
        {
            RootFrame.Navigating -= RootFrame_OnNavigating;
